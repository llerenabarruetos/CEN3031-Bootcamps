var path = require('path'),  
    ...
    listingsRouter = require('../routes/listings.server.routes'),   //Route #1
    getCoordinates = require('../controllers/coordinates.server.controller.js');    //Controller #1
...
module.exports.init = function() {
  ...
  //When the user goes to the address "..../", they are redirected to the static page
